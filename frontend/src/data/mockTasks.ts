...
export const mockTasks: Task[] = [
    {
        ...
        priority: "high",
        owner: "Shivang",
        assignees: [{ id: "u_1", name: "Shivang", email: "shivang@example.com" }, { id: "u_2", name: "Aisha", email: "aisha@example.com" }],
        ...
        dependencies: [
            { id: "dep_01", title: "Finalize sidebar nav", status: "done", priority: "medium", due_date: new Date(Date.now() - 1000 * 60 * 60 * 24 * 3).toISOString() },
            { id: "dep_02", title: "Decide task statuses", status: "in-progress", priority: "low", due_date: new Date(Date.now() + 1000 * 60 * 60 * 24 * 1).toISOString() },
        ],
        context: [
    ...
    },
    {
        ...
        priority: "medium",
        owner: "Aisha",
        assignees: [{ id: "u_2", name: "Aisha", email: "aisha@example.com" }],
        labels: ["frontend"],
        storyPoints: 8,
        ...
        dependencies: [{ id: "dep_11", title: "Define Task Module UI", status: "in-progress", priority: "high", due_date: new Date(Date.now() - 1000 * 60 * 60 * 24 * 1).toISOString() }],
    ...
    },
    {
        ...
        priority: "urgent",
        owner: "Rohan",
        assignees: [{ id: "u_3", name: "Rohan", email: "rohan@example.com" }, { id: "u_1", name: "Shivang", email: "shivang@example.com" }],
        labels: ["backend", "bug"],
        storyPoints: 3,
        ...
        dependencies: [{ id: "dep_21", title: "Supabase session audit", status: "in-progress", priority: "high", due_date: new Date(Date.now() - 1000 * 60 * 60 * 24 * 6).toISOString() }],
        context: [
