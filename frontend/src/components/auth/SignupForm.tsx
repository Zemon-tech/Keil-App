 ...
 * Handles form state, validation, and submission to Supabase Auth.
 * Includes a full name field for synchronization with MongoDB.
 * 
 * @param className - Optional CSS class name
 * @param onSwitchToLogin - Callback to switch the UI to the login form
 */
export function SignupForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      // User is logged in automatically, the page will auto-route to dashboard/onboarding
      setLoading(false);
      return;
    } else {
      // Email verification is required or no session established yet
  ...
  const handleGoogleLogin = async () => {
    ...
    // On success, the browser will redirect — no manual setLoading(false) needed
  };
