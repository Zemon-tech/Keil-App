...
export function ChatPage() {
  ...
  return (
    <div className="flex h-[calc(100vh-3.5rem)] bg-background">
      ...
      {/* Main Chat Area - Fully delegated to Real MessageView */}
      {activeChannelId ? (
        <MessageView channelId={activeChannelId} />
      ) : (
        <div className="flex-1 flex flex-col items-center justify-center text-muted-foreground bg-card p-12 text-center rounded-r-xl border border-border border-l-0 shadow-sm relative overflow-hidden group">
